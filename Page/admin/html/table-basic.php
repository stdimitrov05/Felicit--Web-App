            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="iptable.php" aria-expanded="false">
                                <i data-feather="grid" class="feather-icon"></i>
                                <span class="hide-menu">Ip Adrees Table</span>
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Acounts Table</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="dashboard.html" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item "><a href="../sql/export.php">Export Table</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="../sql/delete.php?id=<?php echo $row["id"] ?>">Delete <?php echo $row["name"]; ?>`s Acount</a></td>
                                                    <td><a href="../sql/update.php?id=<?php echo $row["id"] ?>">Update <?php echo $row["name"]; ?>`s Acount</a></td>
